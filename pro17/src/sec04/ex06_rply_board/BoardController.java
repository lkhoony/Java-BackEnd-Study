	...
	protected void doHandle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (action == null || action.equals("/listArticles.do")) {
				...
				nextPage = "/sec04ex06_mvc_board_rply/ListArticles.jsp";
				...
				nextPage = "/sec04ex06_mvc_board_rply/viewArticle.jsp";
				
			}else if(action.equals("/articleForm.do")) {
				nextPage = "/sec04ex06_mvc_board_rply/articleForm.jsp";
				...
				nextPage = "/sec04ex06_mvc_board_rply/replyForm.jsp";
