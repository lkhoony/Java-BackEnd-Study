package sec04.ex07_paging_board;
...
//				articlesList = boardService.listArticles();
				...
				int pageNum = Integer.parseInt(pageNumStr==null ? "1" : pageNumStr);
				...
				nextPage = "/sec04ex07_mvc_board_paging/ListArticles.jsp";
				...
				for(int articleNOItem : articleNOList) {
					
					File imgDir = new File(ARTICLE_IMAGE_REPO+"\\"+articleNOItem);
				...
				nextPage = "/sec04ex07_mvc_board_paging/viewArticle.jsp";
				
			}else if(action.equals("/articleForm.do")) {
				nextPage = "/sec04ex07_mvc_board_paging/articleForm.jsp";
				...
				nextPage = "/sec04ex07_mvc_board_paging/replyForm.jsp";
